    ...
    public class UnitTest1
    {
        ...
        public void TestLogin()
        {
            ...
            catch(SqliteException sqliteException)
            {
                ...
                Assert.Inconclusive("Database has not been migrated correctly on this machine. " + 
                    "Database migration must be applied on each machine before the program can be tested.");
            }
